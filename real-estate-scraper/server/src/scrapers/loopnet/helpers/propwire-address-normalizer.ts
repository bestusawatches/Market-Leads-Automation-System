/**
 * Normalize LoopNet addresses to Propwire format
 *
 * Propwire format: "Street, City, State, ZipCode"
 */
...
function extractPropwireAddressComponents(
...
function formatPropwireAddress(components: PropwireAddressComponents): string | undefined {
...
export function normalizeToPropwireFormat(listing: RawListing): string | undefined {
  const components = extractPropwireAddressComponents(listing.address, listing.location, listing.source);
